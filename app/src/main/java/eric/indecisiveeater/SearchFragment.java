...
public class SearchFragment extends Fragment implements ConnectionCallbacks, OnConnectionFailedListener {
    @InjectView(R.id.user_location) TextView mLocationField;
    @InjectView(R.id.recommend_button) Button mRecommendButton;
